...
class ClientHandler implements Runnable {
    ...
    public void run() {
        ...
        try (
            ...
            // --- FASE 1: AUTENTICAZIONE (Senza controllo predefinito) ---

            out.println("Inserisci il tuo Nome Utente:");

            String username = in.readLine(); // Il server legge e salva il nome



            out.println("Inserisci la tua Password:");

            String password = in.readLine(); // Il server legge la password
            ...
            // Verifichiamo che l'input non sia nullo
